...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 2740 | 1224 | 512 | 191 | 813 | 86.5% | 38.6% | 70.5% | 77.7% | 47.9% |

Findings: 2163 total, 2163 inside test cases with a CWE, 0 without a CWE (ignored), 0 outside test-case files (ignored). CWE normalization preset "semgrep" (301 findings translated, per OWASP BenchmarkUtils); multi-CWE rules: all.
