...
`expectedresults.csv` — `name,category,isVulnerable,cwe`; `testcode/<name>.rs` is the analysed source. Despite the name this is a curated set authored for this benchmark, not an external dataset.
