...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 6 | 6 | n/a | n/a | 0 | 100% | n/a | 100% |

`n/a` means the dataset has no scored negatives for that row, not zero.

## Evidence

- `../../results/2026-04-22/results.json` (row `benchmark: "DVPWA"`)
